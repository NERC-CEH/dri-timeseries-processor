...
from new_processor.configuration.app_config import AppConfigLive, AppConfigLocal, app_config
...
def patch_local(filename: str, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("new_processor.configuration.app_config.LOCAL_CONFIG_PATH", filename)
