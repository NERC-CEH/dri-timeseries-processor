...
class TestS3StorageClient:
    ...
    @pytest.fixture
    def storage_client_with_files(self, storage_client):
    ...
    def test_get_bytes(self, file_name: str, file_data: str, storage_client_with_files: S3StorageClient):
        result = storage_client_with_files.get_bytes(LOCALSTACK_TEST_BUCKET, file_name)
        assert result == file_data

    def test_put_bytes(self, storage_client: S3StorageClient):
        file_name = "file.txt"
        file_data = b"data"
    ...
    def test_list_keys(self, storage_client_with_files: S3StorageClient):
    ...
    def test_list_keys_empty_bucket(self, storage_client: S3StorageClient):
    ...
    def test_delete_key(self, file_name: str, storage_client_with_files: S3StorageClient):
    ...
    def test_clear_bucket(self, storage_client_with_files: S3StorageClient):
