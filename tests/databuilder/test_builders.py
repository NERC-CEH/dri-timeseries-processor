...
class TestParquetBuilderMethods(DataCase):
    def setUp(self):
        ...
        self.target = Path(f"{self.test_data}/dataset=PRECIP_1MIN_2024_LOOPED/site=BUNNY/date=2024-01-30/data.parquet")
...
class TestTimeClearing(DataCase):
    ...
    def setUp(self):
        ...
        self.target = f"{self.test_data}/dataset=PRECIP_1MIN_2024_LOOPED/site=BUNNY/date=2024-01-30/data.parquet"
...
class TestBuilderWriting(DataCase):
    ...
    def setUp(self):
        ...
        self.target = self.test_data / "dataset=PRECIP_1MIN_2024_LOOPED" / "site=BUNNY" / "date=2024-01-30/data.parquet"
