...
class BaseTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Patch the s3 client
        cls.patch_s3_client = patch("dritimeseriesprocessor.s3_crud.read.s3_client", cls.s3_client)
    ...
    def create_and_upload_test_data(cls):
        ...
        while current_date <= end_date:
            ...
            file_key = f"TEST_CATEGORY/date={current_date.strftime('%Y-%m-%d')}/{current_date.strftime('%Y-%m-%d')}.parquet"
