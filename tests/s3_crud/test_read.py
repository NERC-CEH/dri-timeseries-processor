...
class TestReadParquetByQuery(BaseTestCase):
    ...
    def test_read_parquet_by_query_single_key(self):
        ...
        """
        key = "TEST_CATEGORY/site=site1/date=2024-01-01/data.parquet"
    ...
    def test_read_parquet_by_query_multiple_keys(self):
        ...
        """
        keys = ("TEST_CATEGORY/site=site1/date=2024-01-01/data.parquet",
                "TEST_CATEGORY/site=site1/date=2024-01-02/data.parquet")
    ...
    def test_read_parquet_by_query_glob_keys(self):
        ...
        """
        query = f"SELECT * FROM read_parquet('s3://{self.bucket_name}/TEST_CATEGORY/site=*/date=*/data.parquet')"
        result = self.reader.read(query)
    ...
    def test_read_parquet_by_query_with_single_param(self):
        ...
        """
        key = "TEST_CATEGORY/site=*/date=2024-01-01/data.parquet"
