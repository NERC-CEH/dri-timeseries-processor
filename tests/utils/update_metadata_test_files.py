...
MAPPING = {
    ...
    "dataset_dependencies": {
        "cosmos_bunny_precip_30min_processed.json": f"{BASE_URL}/id/dataset/cosmos-bunny-precip_30min_processed/_dependencies.json",
        "cosmos_bunny_precip_30min_raw.json": f"{BASE_URL}/id/dataset/cosmos-bunny-precip_30min_raw/_dependencies.json",
        "cosmos_bunny_rn_30min_processed.json": f"{BASE_URL}/id/dataset/cosmos-bunny-rn_30min_processed/_dependencies.json",
        "cosmos_bunny_rn_30min_processed_all.json": f"{BASE_URL}/id/dataset/cosmos-bunny-rn_30min_processed/_all_dependencies.json",
        "cosmos_bunny_swin_30min_processed.json": f"{BASE_URL}/id/dataset/cosmos-bunny-swin_30min_processed/_dependencies.json",
        "cosmos_bunny_swin_30min_raw.json": f"{BASE_URL}/id/dataset/cosmos-bunny-swin_30min_raw/_dependencies.json",
    },
    "dataset_timeseries": {
