...
class TestLoadNestedTimeseriesDerivations(unittest.TestCase):
	...
	def test_single_timeseries_definition_nested(self, mock_handle_derivation_response):
		...
		expected = {'http://fdri.ceh.ac.uk/ref/cosmos/time-series/rn_30min_processed': {'methodology': {'method_type': 'calculate', 'inputs': ['http://fdri.ceh.ac.uk/ref/cosmos/time-series/swin_30min_processed']}}, 'http://fdri.ceh.ac.uk/ref/cosmos/time-series/swin_30min_processed': {'methodology': {'method_type': 'process', 'inputs': ['http://fdri.ceh.ac.uk/ref/cosmos/time-series/swin_30min_raw']}}, 'http://fdri.ceh.ac.uk/ref/cosmos/time-series/swin_30min_raw': {'methodology': {'inputs': []}}}
