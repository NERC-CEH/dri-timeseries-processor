...
awslocal s3api put-object --bucket ukceh-fdri-staging-timeseries-level-0 --key SOILMET_1MIN_2024_LOOPED/2024-01/2024-01-21.parquet --body /var/lib/localstack/parquet-data/SOILMET_1MIN_2024_LOOPED/2024-01/2024-01-21.parquet
awslocal s3api put-object --bucket ukceh-fdri-staging-timeseries-level-0 --key SOILMET_1MIN_2024_LOOPED/2024-01/2024-01-22.parquet --body /var/lib/localstack/parquet-data/SOILMET_1MIN_2024_LOOPED/2024-01/2024-01-22.parquet