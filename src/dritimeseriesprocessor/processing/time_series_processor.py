...
class TimeSeriesProcessor:
    ...
    def run(self) -> None:
        ...
        try:
            ...
            # Collect any datasets that failed during the processing run
            self._collect_dataset_failures()
    ...
    def _collect_dataset_failures(self) -> None:
        """Log and raise an exception if any dataset failed to load or process.
    ...
    def process_layer(self, layer: list[str]) -> None:
        ...
        for dataset_id in layer:
            ...
            try:
                ...
                self.metrics.success.labels(dataset=extract_uri_id(dataset_id)).inc()
